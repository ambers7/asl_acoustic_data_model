...
'''
resnet model trained only on j, p, x, and z
...
if __name__ == "__main__":
    ...
    #creates a data loader for the training set (a data loader provides an iterable over the dataset and makes it easy to loop through)
    #collate is above function to pad data to have the same time length 
